...
Telegram bot for automated **4TEEN token airdrop distribution** with membership verification and on-chain reward delivery.

The bot verifies that a user is a member of the **4TEEN Telegram community or channel**, requests a TRON wallet address, and sends a random reward using the `AirdropVault` smart contract.
...
This project is open source and provided for transparency of the **4TEEN ecosystem infrastructure**.
